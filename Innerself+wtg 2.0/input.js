        ...
        if (command === 'sleep') {
          ...
          if (dateStr) {
            ...
            if (parsedSettime) {
              ...
              wtgMessages.push(`[Invalid date: ${dateStr}. Use mm/dd/year [BC|AD] or dd/mm/year [BC|AD]. The year can be 1-6 digits, BC counts down, AD counts up, and AC/CE/BCE aliases are also accepted.]`);
            }
          }
